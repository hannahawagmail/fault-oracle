...
def query_prometheus_instant(metric_expr: str) -> str:  # pragma: no cover
...
def generate_runbook(context: str, alertname: str, instance: str, api_key: str,  # pragma: no cover
